(function () {
    'use strict';
    angular.module('nvControllers').controller('ObservableUpdateCtrl',
        function ($scope, $uibModalInstance, TagSrv, TaxonomyCacheSrv, selection, dataTypes) {
            ...
            this.buildOperations = function (postData) {
                ...
                if (this.canUpdateDataType) {
                    flags = _.pick(postData, 'dataType', 'ioc', 'sighted', 'ignoreSimilarity', 'tlp', 'pap');
                } else {
                    flags = _.pick(postData, 'ioc', 'sighted', 'ignoreSimilarity', 'tlp', 'pap');
                }
